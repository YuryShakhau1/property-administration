...
Результат высылайте в виде ссылки на GitHub.

ВАЖНО! Выполнить задание на 21 версии Java. Соответсвие приложения требованиям будет проверяться в автоматизированной среде.